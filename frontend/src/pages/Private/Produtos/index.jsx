...
import ModalProduto from "../../../components/Modals/ModalProduto/index";
...
export default function Produtos(){
    ...
    const handleUpdateProduto = (produto) => {
        let data = [...tableData.data]
        let toUpdate = findIndex(data,{id:produto.id})
        if(toUpdate === -1) return;
        data[toUpdate] = {...data[toUpdate],...produto}
    ...
    const onDelete = (produto) => {
        Swal.fire({
            ...
            setLoading(true);
            BaseApi.delete(`/produto/${produto.id}`)
            .then(res => {
                toast.success('Product deleted successfully!');
                requestData();
            })
            .catch(err => {
                Swal.fire('Oops!', err?.data?.errors?.[0] || err?.data?.message || 'Ocorreu um erro ao deletar esse produto.')
                setLoading(false);
    ...
    return (
        <>
            ...
            <div className={"d-flex flex-column flex-md-row pb-4"}>
                <div className={`${style.produto} col-12 col-md-4 mb-2`}>
                    <h1>Produto</h1>
                </div>
            ...
            <div className="col-12 col-md-2 d-flex justify-content-end mb-2">
                ...
                <ModalProduto onCreate = {handleCreateProduto}>
                            ...
                            <>
                                ...
                                <table className={`table`}>
                                    ...
                                    {tableData.data.map((item) => (
                                        ...
                                        <td><img className={style.produtoImagem} src={item.imagem} alt="" /></td>
